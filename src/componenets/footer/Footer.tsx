  ...
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <Logo color={'#FFFFFF'} />
        <p className={`${styles.text} ${styles.bigWidth}`}>
          Компания «Султан» — снабжаем розничные магазины товарами "под ключ" в Кокчетаве и
          Акмолинской области
        </p>
        <p className={styles.text}>Подпишись на скидки и акции</p>
        <Input />
      </div>
      <div className={styles.wrapper}>
        <p className={styles.bigText}>Меню сайта:</p>
        <ul className={styles.list}>
          {['О компании', 'Доставка и оплата', 'Возврат', 'Контакты'].map((el, index) => (
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.linkContainer}>
          <p className={styles.link}>
            ...
            >
              <rect width="100%" height="100%" rx="19.5" fill="#00E676" />
              <path
